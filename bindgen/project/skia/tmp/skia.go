...
func init() {
	...
	bindlib.Validate((*Anon40_9)(nil), 32, 8, "Glyphs", 0, "Pos", 8, "Utf8text", 16, "Clusters", 24)
	bindlib.Validate((*Anon53_9)(nil), 8, 4, "X", 0, "Y", 4)
	bindlib.Validate((*Anon58_9)(nil), 8, 4, "X", 0, "Y", 4)
	bindlib.Validate((*Anon65_9)(nil), 12, 4, "X", 0, "Y", 4, "Z", 8)
	bindlib.Validate((*Anon73_9)(nil), 8, 4, "W", 0, "H", 4)
	bindlib.Validate((*Anon80_9)(nil), 16, 4, "Left", 0, "Top", 4, "Right", 8, "Bottom", 12)
	bindlib.Validate((*Anon87_9)(nil), 16, 4, "Left", 0, "Top", 4, "Right", 8, "Bottom", 12)
	bindlib.Validate((*Anon96_9)(nil), 36, 4, "scaleX", 0, "skewX", 4, "transX", 8, "skewY", 12, "scaleY", 16, "transY", 20, "Persp0", 24, "Persp1", 28, "Persp2", 32)
	bindlib.Validate((*Anon193_9)(nil), 12, 4, "fFBOID", 0, "fFormat", 4, "fProtected", 8)
	bindlib.Validate((*Anon275_9)(nil), 12, 4, "Grayscale", 0, "invertStyle", 4, "Contrast", 8)
	bindlib.Validate((*Anon375_9)(nil), 24, 8, "colorSpace", 0, "colorType", 8, "alphaType", 12, "Width", 16, "Height", 20)
	bindlib.Validate((*Anon406_9)(nil), 8, 4, "B", 0, "C", 4)
	bindlib.Validate((*Anon424_9)(nil), 24, 4, "maxAniso", 0, "useCubic", 4, "Cubic", 8, "Filter", 16, "Mipmap", 20)
	bindlib.Validate((*Anon503_9)(nil), 64, 4, "Flags", 0, "Top", 4, "Ascent", 8, "Descent", 12, "Bottom", 16, "Leading", 20, "avgCharWidth", 24, "maxCharWidth", 28, "xMin", 32, "xMax", 36, "xHeight", 40, "capHeight", 44, "underlineThickness", 48, "underlinePosition", 52, "strikeoutThickness", 56, "strikeoutPosition", 60)
	bindlib.Validate((*Anon555_9)(nil), 10, 2, "timeZoneMinutes", 0, "Year", 2, "Month", 4, "dayOfWeek", 5, "Day", 6, "Hour", 7, "Minute", 8, "Second", 9)
	bindlib.Validate((*Anon574_9)(nil), 80, 8, "Title", 0, "Author", 8, "Subject", 16, "Keywords", 24, "Creator", 32, "Producer", 40, "Creation", 48, "Modified", 58, "rasterDPI", 68, "Unused", 72, "encodingQuality", 76)
}
...
func SkCanvasClipRectWithOperation(t unsafe.Pointer, crect unsafe.Pointer, op SkClipOpT, doAA bool) {
...
func SkCanvasConcat(canvas unsafe.Pointer, matrix unsafe.Pointer) {
...
func SkCanvasDrawArc(canvas unsafe.Pointer, oval unsafe.Pointer, startAngle float32, sweepAngle float32, useCenter bool, paint unsafe.Pointer) {
...
func SkCanvasDrawImageNine(t unsafe.Pointer, image unsafe.Pointer, center unsafe.Pointer, dst unsafe.Pointer, filter SkFilterModeT, paint unsafe.Pointer) {
...
func SkCanvasDrawImageRect(canvas unsafe.Pointer, cimage unsafe.Pointer, csrcR unsafe.Pointer, cdstR unsafe.Pointer, samplingOptions unsafe.Pointer, cpaint unsafe.Pointer, constraint SkSrcRectConstraintT) {
...
func SkCanvasDrawOval(canvas unsafe.Pointer, crect unsafe.Pointer, cpaint unsafe.Pointer) {
...
func SkCanvasDrawPoints(canvas unsafe.Pointer, pointMode SkPointModeT, count uint, points unsafe.Pointer, cpaint unsafe.Pointer) {
...
func SkCanvasDrawRect(canvas unsafe.Pointer, crect unsafe.Pointer, cpaint unsafe.Pointer) {
...
func SkCanvasDrawRoundRect(canvas unsafe.Pointer, crect unsafe.Pointer, rx float32, ry float32, cpaint unsafe.Pointer) {
...
func SkCanvasGetLocalClipBounds(canvas unsafe.Pointer, cbounds unsafe.Pointer) bool {
...
func SkCanvasGetTotalMatrix(canvas unsafe.Pointer, matrix unsafe.Pointer) {
...
func SkCanvasQuickRejectRect(canvas unsafe.Pointer, rect unsafe.Pointer) bool {
...
func SkCanvasSaveLayer(canvas unsafe.Pointer, crect unsafe.Pointer, cpaint unsafe.Pointer) int32 {
...
func SkCanvasSaveLayerAlpha(canvas unsafe.Pointer, crect unsafe.Pointer, alpha uint8) int32 {
...
func SkCanvasSetMatrix(canvas unsafe.Pointer, matrix unsafe.Pointer) {
...
func SkImageMakeShader(image unsafe.Pointer, tileX SkTileModeT, tileY SkTileModeT, samplingOptions unsafe.Pointer, cmatrix unsafe.Pointer) unsafe.Pointer {
...
func SkImagefilterNewBlur(sigmaX float32, sigmaY float32, tileMode SkTileModeT, input unsafe.Pointer, cropRect unsafe.Pointer) unsafe.Pointer {
...
func SkImagefilterNewDilate(radiusX int32, radiusY int32, input unsafe.Pointer, cropRect unsafe.Pointer) unsafe.Pointer {
...
func SkImagefilterNewErode(radiusX int32, radiusY int32, input unsafe.Pointer, cropRect unsafe.Pointer) unsafe.Pointer {
...
func SkImagefilterNewImageSource(image unsafe.Pointer, srcRect unsafe.Pointer, dstRect unsafe.Pointer, samplingOptions unsafe.Pointer) unsafe.Pointer {
...
func SkImagefilterNewImageSourceDefault(image unsafe.Pointer, samplingOptions unsafe.Pointer) unsafe.Pointer {
...
func SkImagefilterNewMagnifier(lensBounds unsafe.Pointer, zoomAmount float32, inset float32, samplingOptions unsafe.Pointer, input unsafe.Pointer, cropRect unsafe.Pointer) unsafe.Pointer {
...
func SkImagefilterNewMatrixConvolution(kernelSize unsafe.Pointer, kernel *float32, gain float32, bias float32, kernelOffset unsafe.Pointer, tileMode SkTileModeT, convolveAlpha bool, input unsafe.Pointer, cropRect unsafe.Pointer) unsafe.Pointer {
...
func SkImagefilterNewMatrixTransform(matrix unsafe.Pointer, samplingOptions unsafe.Pointer, input unsafe.Pointer) unsafe.Pointer {
...
func SkImagefilterNewMerge(filters *unsafe.Pointer, count int32, cropRect unsafe.Pointer) unsafe.Pointer {
...
func SkPaintGetFillPath(cpaint unsafe.Pointer, src unsafe.Pointer, dst unsafe.Pointer, cullRect unsafe.Pointer, resScale float32) bool {
...
func SkPathAddOval(cpath unsafe.Pointer, crect unsafe.Pointer, cdir SkPathDirectionT) {
...
func SkPathAddRect(cpath unsafe.Pointer, crect unsafe.Pointer, cdir SkPathDirectionT) {
...
func SkPathAddRoundedRect(cpath unsafe.Pointer, crect unsafe.Pointer, rx float32, ry float32, cdir SkPathDirectionT) {
...
func SkPathArcToWithOval(cpath unsafe.Pointer, oval unsafe.Pointer, startAngle float32, sweepAngle float32, forceMoveTo bool) {
...
func SkPathComputeTightBounds(cpath unsafe.Pointer, crect unsafe.Pointer) {
...
func SkPathGetBounds(cpath unsafe.Pointer, crect unsafe.Pointer) {
...
func SkShaderNewLinearGradient(points unsafe.Pointer, colors *SkColorT, colorPos *float32, colorCount int32, tileMode SkTileModeT, localMatrix unsafe.Pointer) unsafe.Pointer {
...
func SkShaderNewRadialGradient(center unsafe.Pointer, radius float32, colors *SkColorT, colorPos *float32, colorCount int32, tileMode SkTileModeT, localMatrix unsafe.Pointer) unsafe.Pointer {
...
func SkShaderNewSweepGradient(center unsafe.Pointer, colors *SkColorT, colorPos *float32, colorCount int32, tileMode SkTileModeT, startAngle float32, endAngle float32, localMatrix unsafe.Pointer) unsafe.Pointer {
...
func SkShaderNewTwoPointConicalGradient(start unsafe.Pointer, startRadius float32, end unsafe.Pointer, endRadius float32, colors *SkColorT, colorPos *float32, colorCount int32, tileMode SkTileModeT, localMatrix unsafe.Pointer) unsafe.Pointer {
...
func SkSurfaceMakeRasterDirect(imageInfo unsafe.Pointer, pixels unsafe.Pointer, rowBytes uint, surfaceProps unsafe.Pointer) unsafe.Pointer {
...
func SkSurfaceMakeRasterN32Premul(imageInfo unsafe.Pointer, surfaceProps unsafe.Pointer) unsafe.Pointer {
...
func SkTextblobBuilderAllocRun(builder unsafe.Pointer, font unsafe.Pointer, count int32, x float32, y float32, bounds unsafe.Pointer) unsafe.Pointer {
...
func SkTextblobBuilderAllocRunPos(builder unsafe.Pointer, font unsafe.Pointer, count int32, bounds unsafe.Pointer) unsafe.Pointer {
...
func SkTextblobBuilderAllocRunPosH(builder unsafe.Pointer, font unsafe.Pointer, count int32, y float32, bounds unsafe.Pointer) unsafe.Pointer {
...
func SkDocumentMakePdf(stream unsafe.Pointer, metadata unsafe.Pointer) unsafe.Pointer {
