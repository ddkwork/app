...
// EnumTypes selecting the syntax to format the disassembly in.
...
// EnumTypes selecting a property of the formatter.
...
// EnumTypes defining different mantissae to be used during formatting.
...
// EnumTypes defining the signeness of integers to be used during formatting.
...
// EnumTypes definining magic values that receive special treatment when used as padding properties
// of the formatter.
type Padding int32
...
// EnumTypes selecting a formatter function to be replaced with hooks.
...
// EnumTypes of all decorator types.
...
func init() {
	...
	bindlib.Validate((*ShortString)(nil), 9, 1)
	bindlib.Validate((*RegisterContext)(nil), 2128, 8, "Values", 0)
	bindlib.Validate((*DecodedOperandReg)(nil), 4, 4, "Value", 0)
	bindlib.Validate((*DecodedOperandMem)(nil), 40, 8, "Type", 0, "Segment", 4, "Base", 8, "Index", 12, "Scale", 16, "Disp", 24)
	bindlib.Validate((*DecodedOperandMemDisp_)(nil), 16, 8, "HasDisplacement", 0, "Value", 8)
	bindlib.Validate((*DecodedOperandPtr)(nil), 8, 4, "Segment", 0, "Offset", 4)
	...
	bindlib.Validate((*DecodedInstructionRawVex)(nil), 10, 1, "R", 0, "X", 1, "B", 2, "MMmmm", 3, "W", 4, "Vvvv", 5, "L", 6, "Pp", 7, "Offset", 8, "Size", 9)
	bindlib.Validate((*DecodedInstructionRawEvex)(nil), 15, 1, "R", 0, "X", 1, "B", 2, "R2", 3, "Mmm", 4, "W", 5, "Vvvv", 6, "Pp", 7, "Z", 8, "L2", 9, "L", 10, "Br", 11, "V2", 12, "Aaa", 13, "Offset", 14)
	bindlib.Validate((*DecodedInstructionRawMvex)(nil), 13, 1, "R", 0, "X", 1, "B", 2, "R2", 3, "Mmmm", 4, "W", 5, "Vvvv", 6, "Pp", 7, "E", 8, "Sss", 9, "V2", 10, "Kkk", 11, "Offset", 12)
	bindlib.Validate((*DecodedInstructionAvx)(nil), 36, 4, "VectorLength", 0, "Mask", 4, "Broadcast", 12, "Rounding", 20, "Swizzle", 24, "Conversion", 28, "HasSae", 32, "HasEvictionHint", 33)
	bindlib.Validate((*DecodedInstructionAvxMask_)(nil), 8, 4, "Mode", 0, "Reg", 4)
	bindlib.Validate((*DecodedInstructionAvxBroadcast_)(nil), 8, 4, "IsStatic", 0, "Mode", 4)
	bindlib.Validate((*DecodedInstructionAvxRounding_)(nil), 4, 4, "Mode", 0)
	bindlib.Validate((*DecodedInstructionAvxSwizzle_)(nil), 4, 4, "Mode", 0)
	bindlib.Validate((*DecodedInstructionAvxConversion_)(nil), 4, 4, "Mode", 0)
	...
	bindlib.Validate((*DecodedInstructionRawImm_)(nil), 24, 8, "IsSigned", 0, "IsRelative", 1, "Value", 8, "Size", 16, "Offset", 17)
	...
	bindlib.Validate((*EncoderOperandMem_)(nil), 32, 8, "Base", 0, "Index", 4, "Scale", 8, "Displacement", 16, "Size", 24)
	bindlib.Validate((*EncoderOperandPtr_)(nil), 8, 4, "Segment", 0, "Offset", 4)
	bindlib.Validate((*EncoderOperandImm_)(nil), 8, 8)
	bindlib.Validate((*EncoderRequest)(nil), 400, 8, "MachineMode", 0, "AllowedEncodings", 4, "Mnemonic", 8, "Prefixes", 16, "BranchType", 24, "BranchWidth", 28, "AddressSizeHint", 32, "OperandSizeHint", 36, "OperandCount", 40, "Operands", 48, "Evex", 368, "Mvex", 380)
	bindlib.Validate((*EncoderRequestEvexFeatures_)(nil), 12, 4, "Broadcast", 0, "Rounding", 4, "Sae", 8, "ZeroingMask", 9)
	bindlib.Validate((*EncoderRequestMvexFeatures_)(nil), 20, 4, "Broadcast", 0, "Conversion", 4, "Rounding", 8, "Swizzle", 12, "Sae", 16, "EvictionHint", 17)
	bindlib.Validate((*Allocator)(nil), 24, 8, "Allocate", 0, "Reallocate", 8, "Deallocate", 16)
	bindlib.Validate((*Vector)(nil), 56, 8, "Allocator", 0, "GrowthFactor", 8, "ShrinkThreshold", 9, "Size", 16, "Capacity", 24, "ElementSize", 32, "Destructor", 40, "Data", 48)
	bindlib.Validate((*String)(nil), 64, 8, "Flags", 0, "Vector", 8)
	bindlib.Validate((*StringView)(nil), 64, 8, "String", 0)
	bindlib.Validate((*FormatterToken)(nil), 2, 1, "Type", 0, "Next", 1)
