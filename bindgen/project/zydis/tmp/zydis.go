...
func init() {
	...
	bindlib.Validate((*RegisterContext)(nil), 0x850, 0x8, "Values", 0x0)
	...
	bindlib.Validate((*DecodedOperandMemDisp_)(nil), 0x10, 0x8, "HasDisplacement", 0x0, "Value", 0x8)
	bindlib.Validate((*DecodedOperandPtr)(nil), 0x8, 0x4, "Segment", 0x0, "Offset", 0x4)
	bindlib.Validate((*DecodedOperandImm)(nil), 0x10, 0x8, "IsSigned", 0x0, "IsRelative", 0x1, "Value", 0x8)
	...
	bindlib.Validate((*Anon5338_5)(nil), 0x28, 0x8)
	...
	bindlib.Validate((*Anon6217_5)(nil), 0xf, 0x1)
	...
	bindlib.Validate((*Anon6451_5)(nil), 0xa, 0x1, "W", 0x0, "R", 0x1, "X", 0x2, "B", 0x3, "L", 0x4, "Ll", 0x5, "R2", 0x6, "V2", 0x7, "Vvvv", 0x8, "Mask", 0x9)
	bindlib.Validate((*Anon6467_5)(nil), 0x6, 0x1, "IsModReg", 0x0, "IdReg", 0x1, "IdRm", 0x2, "IdNdsndd", 0x3, "IdBase", 0x4, "IdIndex", 0x5)
	bindlib.Validate((*Anon6504_5)(nil), 0x2, 0x1, "TupleType", 0x0, "ElementSize", 0x1)
	bindlib.Validate((*Anon6518_5)(nil), 0x1, 0x1, "Functionality", 0x0)
	...
	bindlib.Validate((*Anon11276_5)(nil), 0x58, 0x8, "String", 0x0, "StringData", 0x8, "Buffer", 0x48)
	bindlib.Validate((*InstructionSegments)(nil), 0x4c, 0x4, "Count", 0x0, "Segments", 0x4)
	bindlib.Validate((*Anon11687_5)(nil), 0x8, 0x4, "Type", 0x0, "Offset", 0x4, "Size", 0x5)
...
func (request *EncoderRequest) DecodedInstructionToEncoderRequest(instruction *DecodedInstruction, operands *DecodedOperand, operand_count U8) Status {
	__res := bindlib.CCall4(__imp_ZydisEncoderDecodedInstructionToEncoderRequest.Addr(), bindlib.MarshallSyscall(instruction), bindlib.MarshallSyscall(operands), bindlib.MarshallSyscall(operand_count), bindlib.MarshallSyscall(request))
	return bindlib.UnmarshallSyscall[Status](__res)
}
